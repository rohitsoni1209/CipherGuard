...
args = argparse.ArgumentParser(
    ...
    "\n\033[1;34m"
    "╔═════════════════════════════════════════════════════════════╗\n"
    "║             CipherGuard: Random Password Generator          ║\n"
    "║                   Tool by -- \033[1;33m'Rohit Soni'\033[1;34m                   ║\n"
    "║                     \033[1;32mBuilt with Python\033[1;34m                       ║\n"
    "╚═════════════════════════════════════════════════════════════╝\n\n"
    "\033[0m"
    "CipherGuard helps you generate secure random passwords with customizable options.\n"
